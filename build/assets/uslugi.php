...
<head>
    ...
    <link rel="icon" href="i/logo2.png">
...
<nav class="navbar navbar-expand-md navbar-dark bg-secondary fixed-top h4" style="font-family: cheltenham">
    <a class="navbar-brand h1" href="#"><img src="i/logo2.png" width="60" height="60" class="d-inline-block align-top" style="opacity: 0.5" alt="">  </a> <a style="font-family: 'Conv_franklin-cword-normal-500',Sans-Serif; opacity: 0.5">NPhotography</a>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
        <ul class="navbar-nav">
            <li class="nav-item ">
                <a class="nav-link" href="index.php">Портфолио</a>
            </li>
