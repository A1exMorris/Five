...
<!--                <span class="text-muted">VK F Tel Inst</span>-->
    ...
    NPhotography
            ...
            <div class="col-md-3 col-sm-12" >
                ...
                <ul class="my-1 pl-0 d-none d-md-block"><a href="#"> Альбом 1 </a></ul>
                <ul class="my-1 pl-0 d-none d-md-block"><a href="#"> Альбом 2 </a></ul>
                <ul class="my-1 pl-0 d-none d-md-block"><a href="#"> Альбом 3 </a></ul>
            </div>
            <div class="col-md-3 col-sm-12">
                <ul class="my-md-2 pl-0 mainTitle1">ИНФОРМАЦИЯ</ul>
                <ul class="my-1 pl-0 d-none d-md-block"><a href="#">Услуги</a></ul>
                <ul class="my-1 pl-0 d-none d-md-block"><a href="#">Блог</a></ul>
                <ul class="my-1 pl-0 d-none d-md-block"><a href="#">Отзывы</a></ul>
            </div>
